...
const dict: Dictionary = {
  ...
  "contact.contactForm": { vi: "Liên hệ", en: "Contact Form" },
  "contact.contactFormDescription": { vi: "Chúng tôi sẽ liên hệ lại với bạn trong vòng 24 giờ", en: "Fill out the form below and we'll get back to you within 24 hours" },
  "contact.name": { vi: "Tên", en: "Full Name" },
